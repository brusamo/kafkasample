...
@RestController
@RequestMapping("/api/kafkasample-sample-kafka")
public class KafkasampleSampleKafkaResource {

    private final Logger log = LoggerFactory.getLogger(KafkasampleSampleKafkaResource.class);
    ...
    public KafkasampleSampleKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
