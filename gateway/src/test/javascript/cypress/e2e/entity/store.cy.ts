...
describe('Store e2e test', () => {
  ...
  const storeSample = { name: 'Mountains wireless Market', address: 'overriding', createTimestamp: '2022-10-19T18:51:02.664Z' };
  ...
  describe('new Store page', () => {
    ...
    it('should create an instance of Store', () => {
      ...
      cy.get(`[data-cy="createTimestamp"]`).type('2022-10-20T04:09').blur().should('have.value', '2022-10-20T04:09');

      cy.get(`[data-cy="updateTimestamp"]`).type('2022-10-19T14:57').blur().should('have.value', '2022-10-19T14:57');
